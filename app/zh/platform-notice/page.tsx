...
export const metadata: Metadata = {
  title: "平台说明 | AI Price Guide",
  description:
    "了解 AI Price Guide 如何展示第三方平台信息、价格提示和风险因素。",
  alternates: {
...
const paragraphs = [
  "AI Price Guide 是一个独立信息网站，帮助用户比较 AI 订阅价格、官方方案、共享平台选项、可用性提示和风险因素。",
  "AI Price Guide 不销售账号、不处理付款、不管理订阅，也不为第三方平台提供客服支持。",
  "所有平台信息仅供参考。价格、可用性、退款规则、访问稳定性和平台政策都可能随时间变化。",
  "如果用户选择访问第三方平台，应在做决定前查看该平台自己的服务条款、价格、退款政策和账号访问规则。",
  "AI Price Guide 不对第三方平台的价格、服务质量、账号访问、退款或支持负责。",
];
