...
export function Header() {
  ...
  return (
    <header className="page-shell relative flex min-h-[64px] flex-wrap items-center justify-between gap-y-2 py-3 md:flex-nowrap md:py-0">
      ...
      <nav
        ...
        className="order-3 flex w-full items-center justify-center gap-5 text-xs font-medium text-[#303642] md:absolute md:left-1/2 md:order-none md:w-auto md:-translate-x-1/2 md:gap-8 md:text-[13px]"
      >
      ...
      <a
        className="inline-flex min-h-8 items-center px-3 text-xs font-medium text-[#4b5563] transition-colors hover:text-[#0071e3]"
